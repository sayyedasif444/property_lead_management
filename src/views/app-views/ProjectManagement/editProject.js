...
import { editProject } from '../../../apis/dashboard/Project';
  ...
  useEffect(() => {
    if (Object.keys(singleData).length > 0 && visible) {
      form.setFieldsValue({
        ...
        broker: singleData.broker !== null ? singleData.broker : '',
        date_of_agreement:
...
export default connect(mapStateToProps, { editProject })(AddUser);
