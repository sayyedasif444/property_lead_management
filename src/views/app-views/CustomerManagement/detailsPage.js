...
const ViewProperty = ({ singleData, errMessage, isError, isErrorType }) => {
  ...
  const handleDownload = () => {
    ...
    doc.html(pdfRef.current, {
      async callback(doc) {
        await doc.save('Cusomter' + singleData.id);
      },
    });
  };
  ...
  return (
    <div>
        ...
        <Row>
          ...
          <Col lg={24} className='mt-0'>
            <Row>
              ...
              <Col sm={6} className='border p-2'>
                <h5 className='mb-0'>End of aggrement</h5>
                <p className='mb-0'>
      ...
      <Card>
        <Row>
          <Col lg={24} className=''>
            {Object.keys(singleData).length > 0 && <Repayments />}
          </Col>
        </Row>
      </Card>
      <Card>
          ...
          {singleData !== null && Object.keys(singleData).length > 0 && (
            <div>
              ...
              <div style={styles.fullWidth}>
                ...
                <h5 className='' style={{ width: '410px', fontSize: '9px' }}>
                  Total Refund:{' '}
                  {singleData.customerRepayments.reduce(
                    (accumulator, object) => {
                      return accumulator + parseFloat(object.amount);
                    },
                    0
              ...
              <div style={styles.fullWidth}>
                ...
                <h5 className='' style={{ width: '410px', fontSize: '9px' }}>
                  Total Expense:{' '}
                  {singleData.customerExpenses.reduce((accumulator, object) => {
                    return accumulator + parseFloat(object.amount);
                  }, 0)}
                </h5>
              </div>
