...
import { editPayment } from '../../../../apis/dashboard/Customer';
...
const AddUser = ({
  ...
  useEffect(() => {
    if (editPaymentData !== null && visible) {
      form.setFieldsValue({
        payment_type:
          editPaymentData.payment_type !== null
            ? editPaymentData.payment_type
            : '',
        date_of_payment:
          editPaymentData.date_of_payment !== null
            ? moment(editPaymentData.date_of_payment)
            : '',
...
export default connect(mapStateToProps, { editPayment })(AddUser);
