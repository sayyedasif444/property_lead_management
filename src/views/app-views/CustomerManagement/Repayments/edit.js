...
import { editRepayment } from '../../../../apis/dashboard/Customer';
...
const AddUser = ({
  ...
  useEffect(() => {
    if (editPaymentData !== null && visible) {
      form.setFieldsValue({
        particular:
          editPaymentData.particular !== null ? editPaymentData.particular : '',
        date_of_expense:
          editPaymentData.date_of_expense !== null
            ? moment(editPaymentData.date_of_expense)
            : '',
...
export default connect(mapStateToProps, { editRepayment })(AddUser);
