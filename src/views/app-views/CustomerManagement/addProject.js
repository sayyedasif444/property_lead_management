...
import { addCustomer } from '../../../apis/dashboard/Customer';
...
const AddUser = ({
  ...
  }, [isError, isErrorType, errMessage, form, cancel, history]);
...
export default connect(mapStateToProps, { addCustomer })(AddUser);
